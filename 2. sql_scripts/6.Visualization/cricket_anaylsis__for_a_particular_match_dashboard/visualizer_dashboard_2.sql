...
select  total_score_by_team_a from cricket.consumption.match_fact where match_id=4690; 

--runs scored by team_b
select total_score_by_team_b from cricket.consumption.match_fact where match_id=4690; --run this one